...
namespace WPFDeveloper.Services
{
    ...
    /// 基于自动注册的导航注册表
    /// </summary>
    public class AutoNavigationRegistry : INavigationRegistry
    {
        private readonly IViewAutoRegistration _viewAutoRegistration;
        private readonly ILogger<AutoNavigationRegistry> _logger;

        public AutoNavigationRegistry(IViewAutoRegistration viewAutoRegistration, ILogger<AutoNavigationRegistry> logger)
        {
