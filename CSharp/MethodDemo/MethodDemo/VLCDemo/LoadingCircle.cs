...
namespace VLCDemo
{
    public class LoadingCircle : LoadingBase
    {
        ...
        {
            get { return (double)GetValue(DotOffSetProperty); }
            set { SetValue(DotOffSetProperty, value); }
        }

        // Using a DependencyProperty as the backing store for DotOffSet.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty DotOffSetProperty =
            DependencyProperty.Register("DotOffSet", typeof(double), typeof(LoadingCircle), new FrameworkPropertyMetadata(20.0, FrameworkPropertyMetadataOptions.AffectsRender));



        public bool NeedHidden
        {
            get { return (bool)GetValue(NeedHiddenProperty); }
            set { SetValue(NeedHiddenProperty, value); }
        }

        // Using a DependencyProperty as the backing store for NeedHidden.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty NeedHiddenProperty =
            DependencyProperty.Register("NeedHidden", typeof(bool), typeof(LoadingCircle), new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.AffectsRender));


        static LoadingCircle()
        {
            DotSpeedProperty.OverrideMetadata(typeof(LoadingCircle), new FrameworkPropertyMetadata(6.0, FrameworkPropertyMetadataOptions.AffectsRender));
            DotDelayTimeProperty.OverrideMetadata(typeof(LoadingCircle), new FrameworkPropertyMetadata(220.0, FrameworkPropertyMetadataOptions.AffectsRender));
        }

        protected override void UpadateDots()
        {
