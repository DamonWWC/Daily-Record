...
export default {
    ...
    watch: {
        ...
        currentStage (newV) {
            console.log('currentStage: ', this.currentStage, this.isProcessStart);
            this.getTableList(newV, this.isProcessStart);
        },
        isProcessStart (newV) {
            console.log('isProcessStart: ', this.isProcessStart);
