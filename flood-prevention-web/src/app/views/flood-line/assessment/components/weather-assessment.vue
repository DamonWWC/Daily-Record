      ...
      <div class="h-full" style="padding:1rem 0 .75rem 0; ">
        <div class="grid grid-cols-2 gap-x-6" style="height:calc(100% - 1.75rem)">
          ...
          <div class="index-box">
            ...
            <div v-if="rainGrade" class="flex items-center justify-center rain-grade">
...
export default {
    ...
    computed: {
        topic () {
            return JSON.stringify(this.$route.query) === '{}' ? null : `/biz/wia/${this.$route.query.lineId}/${this.$route.query.stationId}/weather`;
        }
    }
};
</script>
